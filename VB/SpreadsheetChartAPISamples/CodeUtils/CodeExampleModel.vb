...
Namespace SpreadsheetChartAPISamples
	Public MustInherit Class ExampleCodeEvaluator
		...
		Public Function ExcecuteCodeAndGenerateDocument(ByVal args As CodeEvaluationEventArgs) As Boolean
			Dim finalString As String = FinalCallHelper.CheckModule(args.Language, args.RegionName)
			Dim theCode As String = String.Concat(CodeStart, args.Code, finalString, CodeEnd)
